(function($) {
    $(document).ready(function() {
        ...
        function mytheme_add_file(event, selector) {
            ...
            frame.on('select', function() {
                ...
                selector.find('.remove-image, .remove-file').on('click', function() {
                    mytheme_remove_file($(this).parents('.section'));
                });
            });
        ...
        function mytheme_remove_file(selector) {
            ...
            selector.find('.upload-button').live('click', function() {
                mytheme_add_file(event, $(this).parents('.section'));
            });
        }
