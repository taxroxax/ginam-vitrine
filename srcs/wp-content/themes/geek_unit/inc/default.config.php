...
//enlever le p auto et br auto
add_filter('tiny_mce_before_init','geek_unit_tiny_mce_before_init',10,2);
function geek_unit_tiny_mce_before_init($mceInit, $editor_id){
...
add_filter( 'mce_buttons_2', 'geek_unit_mce_buttons_2' );
function geek_unit_mce_buttons_2( $buttons ) {
...
add_action( 'wp_enqueue_scripts', 'geek_unit_default_scripts' );
function geek_unit_default_scripts(){
...
add_filter( 'the_content','geek_unit_default_the_content',9);
function geek_unit_default_the_content($html){
