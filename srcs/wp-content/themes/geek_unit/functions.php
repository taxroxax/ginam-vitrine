<?php
/**
 * geek_unit functions and definitions
 *
 * Sets up the theme and provides some helper functions. Some helper functions
 * are used in the theme as custom template tags. Others are attached to action and
 * filter hooks in WordPress to change core functionality.
 *
 * The first function, geek_unit_setup(), sets up the theme by registering support
 ...
 *     remove_filter( 'excerpt_length', 'geek_unit_excerpt_length' );
 *     ...
 * }
 * </code>
 *
...
/**
 * Tell WordPress to run geek_unit_setup() when the 'after_setup_theme' hook is run.
 */
add_action( 'after_setup_theme', 'geek_unit_setup' );

if ( ! function_exists( 'geek_unit_setup' ) ):
function geek_unit_setup() {
	...
	/* Make geek_unit available for translation.
	 * Translations can be added to the /languages/ directory.
	 * If you're building a theme based on geek_unit, use a find and replace
	 * to change 'geek_unit' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'geek_unit', get_template_directory() . '/languages' );
	...
	register_nav_menu( 'primary', __( 'Primary Menu', 'geek_unit' ) );
