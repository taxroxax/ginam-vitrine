(function($) {
    $(document).ready(function() {
        ...
        function geek_unit_add_file(event, selector) {
            ...
            frame.on('select', function() {
                ...
                selector.find('.remove-image, .remove-file').on('click', function() {
                    geek_unit_remove_file($(this).parents('.section'));
                });
            });
        ...
        function geek_unit_remove_file(selector) {
            ...
            selector.find('.upload-button').live('click', function() {
                geek_unit_add_file(event, $(this).parents('.section'));
            });
        }
